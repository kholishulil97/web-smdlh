            ...
            <div class="row">
                <div class="col-lg">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered" id="tabelSP" width="100%" cellspacing="0">
                            <thead id="table_head">
                                <tr>
                                    <th scope="col">Kru Jalan</th>
                                    <th scope="col">Dinas di</th>
                                    <th scope="col">Trayek</th>
                                    <th scope="col">Menggantikan</th>
                                    <th scope="col">Pengatur Dinas</th>
                                    <th scope="col">Tanggal SP</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#tabelSP').DataTable({
            ...
            'ajax': {
                'url': '<?= base_url() ?>controllerpengaturdinas/logsp'
            },
    ...
    function detail_sp(id) { //menampilkan data yang akan diedit ke dalam modal bootstrap
        ...
        $.ajax({
            url: "<?php echo site_url('controllerpengaturdinas/tampil_sp') ?>/" + id,
            type: "GET",
            dataType: "JSON",
